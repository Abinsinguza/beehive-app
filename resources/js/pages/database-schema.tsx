        ...
        tables: [
            {
                name: 'users',
                columns: [
                    { name: 'user_id',                type: 'uuid',         nullable: false, flags: ['PK'] },
                    ...
                    { name: 'role',                   type: 'varchar(30)',  nullable: false, default: "'farmer'", notes: 'farmer | farmer_pending | farmer_revoked | admin' },
            ...
            },
            {
                name: 'hives',
                columns: [
                    { name: 'hive_id',          type: 'uuid',          nullable: false, flags: ['PK'] },
            ...
            },
            {
                ...
                columns: [
                    { name: 'source_id',         type: 'uuid',      nullable: false, flags: ['PK'] },
                    { name: 'user_id',           type: 'uuid',      nullable: false, flags: ['FK'], ref: 'users.user_id' },
                    { name: 'hive_id',           type: 'uuid',      nullable: false, flags: ['FK', 'UK'], ref: 'hives.hive_id' },
                    { name: 'source_type',       type: 'varchar(50)',nullable: false, default: "'http_api'" },
        ...
        tables: [
            {
                ...
                columns: [
                    ...
                    { name: 'duration_seconds',   type: 'decimal(6,2)',  nullable: true },
            ...
            },
            {
                ...
                columns: [
                    ...
                    { name: 'hive_state',          type: 'varchar(50)',   nullable: false },
                    { name: 'confidence_score',    type: 'decimal(5,4)',  nullable: false },
                    { name: 'inference_latency_ms',type: 'decimal(10,2)', nullable: true },
            ...
            },
            {
                ...
                columns: [
                    ...
                    { name: 'population_k_bees',      type: 'decimal(6,2)', nullable: true },
                    { name: 'nectar_flow_kg_per_day', type: 'decimal(6,2)', nullable: true },
        ...
        tables: [
            {
                ...
                columns: [
                    { name: 'template_id',    type: 'bigint',       nullable: false, flags: ['PK'] },
                    { name: 'prediction_code', type: 'decimal(10,4)',      nullable: false, flags: ['UK'] },
                    { name: 'hive_state',     type: 'varchar(50)',  nullable: false, flags: ['UK'] },
                    { name: 'condition_label',type: 'varchar(100)', nullable: false },
                    { name: 'advisory_text',  type: 'text',         nullable: false },
            ...
            },
            {
                name: 'advisories',
                columns: [
                    { name: 'advisory_id',   type: 'uuid',         nullable: false, flags: ['PK'] },
                    { name: 'inference_id',  type: 'uuid',         nullable: false, flags: ['FK'], ref: 'inference_results.inference_id' },
                    { name: 'hive_id',       type: 'uuid',         nullable: false, flags: ['FK'], ref: 'hives.hive_id' },
                    { name: 'template_id',   type: 'bigint',       nullable: true,  flags: ['FK'], ref: 'advisory_templates.template_id' },
                    { name: 'advisory_type', type: 'varchar(30)',  nullable: false },
                    { name: 'condition_label',type: 'varchar(100)',nullable: true },
                    { name: 'advisory_text', type: 'text',         nullable: true },
                    { name: 'severity',      type: 'varchar(20)',  nullable: false },
                    { name: 'created_at',    type: 'timestamp',    nullable: true },
                    { name: 'updated_at',    type: 'timestamp',    nullable: true },
                ],
            },
            {
                ...
                columns: [
                    { name: 'action_id',         type: 'uuid',        nullable: false, flags: ['PK'] },
                    ...
                    { name: 'priority_level',    type: 'varchar(20)', nullable: false },
                    { name: 'status',            type: 'varchar(20)', nullable: false },
                    { name: 'created_at',        type: 'timestamp',   nullable: true },
                ],
            },
        ...
        tables: [
            {
                ...
                columns: [
                    ...
                    { name: 'action_status',     type: 'varchar(20)', nullable: false },
            ...
            },
            {
                ...
                columns: [
                    { name: 'id',         type: 'bigint',    nullable: false, flags: ['PK'] },
...
DatabaseSchema.layout = {
    breadcrumbs: [{ title: 'Database Schema', href: '/database-schema' }],
};
